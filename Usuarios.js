...
const especialidades = [...new Set(usersData.map(x => x.specialty))]


function usersEspecialidad(esp) {
   return filtrados = usersData.filter(persona => persona.specialty == esp)
}

module.exports = {
    usersData, especialidades,usersEspecialidad,
};